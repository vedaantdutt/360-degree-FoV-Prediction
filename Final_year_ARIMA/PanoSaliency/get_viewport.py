...
if __name__ == "__main__":
	...
	# parser.add_argument('-D', '--dataset 2', type=int, required=True, help='Dataset ID (1 or 2)')
	# parser.add_argument('-T', '--topic 0', required=True, help='Topic in the particular Dataset (video name)')
	# parser.add_argument('30', type=int, required=True, help='fps of the video')
